...
const LOGIN_ERRORS: Record<string,string> = {
  ...
  setup: 'Sign-in reached the app, but one of the connected Google services was not ready. Please try again. If it happens again, the app’s Google connection needs attention.',
};
